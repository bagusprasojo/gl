...
urlpatterns = [
    ...
    path('accounts/<uuid:uuid>/', views.account_detail, name='account_detail'),
    path('accounts/<uuid:uuid>/edit/', views.account_edit, name='account_edit'),
    path('accounts/<uuid:uuid>/delete/', views.account_delete, name='account_delete'),
